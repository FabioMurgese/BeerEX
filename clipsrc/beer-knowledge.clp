...
(defrule determine-best-beer-attributes-if-which-sex-is-male
   ...
   (which-sex male)
   =>
   (assert (attribute (name best-alcohol) (value noticeable)) CF 0.04)
   (assert (attribute (name best-color) (value brown)) CF 0.04)
   (assert (attribute (name best-alcohol) (value harsh)) CF 0.05)
   (assert (attribute (name best-color) (value dark)) CF 0.05)
   (assert (attribute (name best-flavor) (value dark-roasty)) CF 0.05)
   (assert (attribute (name best-flavor) (value hoppy-bitter)) CF 0.05)
   (assert (attribute (name best-flavor) (value sour-tart-funky)) CF 0.05)
...
(defrule determine-best-beer-attributes-if-which-sex-is-female
   ...
   (which-sex female)
   =>
   (assert (attribute (name best-alcohol) (value mild)) CF 0.04)
   (assert (attribute (name best-color) (value amber)) CF 0.04)
   (assert (attribute (name best-alcohol) (value not-detectable)) CF 0.05)
   (assert (attribute (name best-color) (value pale)) CF 0.05)
   (assert (attribute (name best-flavor) (value crisp-clean)) CF 0.05)
   (assert (attribute (name best-flavor) (value malty-sweet)) CF 0.05)
   (assert (attribute (name best-flavor) (value fruity-spicy)) CF 0.05)
...
(defrule determine-best-beer-attributes-if-which-age-is-18-23
   ...
   (which-age 18-23)
   =>
   (assert (attribute (name best-alcohol) (value mild)) CF 0.05)
   (assert (attribute (name best-flavor) (value crisp-clean)) CF 0.05)
...
(defrule determine-best-beer-attributes-if-which-age-is-24-29
   ...
   (which-age 24-29)
   =>
   (assert (attribute (name best-alcohol) (value noticeable)) CF 0.03)
   (assert (attribute (name best-alcohol) (value mild)) CF 0.03)
...
(defrule determine-best-beer-attributes-if-which-age-is-more-or-equal-than-30
   ...
   (which-age >=30)
   =>
   (assert (attribute (name best-flavor) (value dark-roasty)) CF 0.03)
   (assert (attribute (name best-flavor) (value hoppy-bitter)) CF 0.03)
   (assert (attribute (name best-flavor) (value sour-tart-funky)) CF 0.03)
   (assert (attribute (name best-alcohol) (value harsh)) CF 0.04)
   (assert (attribute (name best-alcohol) (value noticeable)) CF 0.05)
...
(defrule determine-best-beer-attributes-if-which-season-is-autumn
   ...
   (which-season autumn)
   =>
   (assert (attribute (name best-alcohol) (value not-detectable)) CF 0.025)
   (assert (attribute (name best-alcohol) (value mild)) CF 0.03)
   (assert (attribute (name best-alcohol) (value noticeable)) CF 0.035)
   (assert (attribute (name best-alcohol) (value harsh)) CF 0.04)
   (assert (attribute (name best-flavor) (value sour-tart-funky)) CF 0.04)
   (assert (attribute (name best-flavor) (value fruity-spicy)) CF 0.05)
...
(defrule determine-best-beer-attributes-if-which-season-is-spring
   ...
   (which-season spring)
   =>
   (assert (attribute (name best-alcohol) (value harsh)) CF 0.025)
   (assert (attribute (name best-alcohol) (value noticeable)) CF 0.03)
   (assert (attribute (name best-alcohol) (value mild)) CF 0.035)
   (assert (attribute (name best-alcohol) (value not-detectable)) CF 0.04)
   (assert (attribute (name best-flavor) (value fruity-spicy)) CF 0.04)
   (assert (attribute (name best-flavor) (value crisp-clean)) CF 0.05)
...
(defrule determine-best-beer-attributes-if-he-is-not-a-regular-beer-drinker
   ...
   =>
   (assert (attribute (name best-flavor) (value crisp-clean)) CF 0.08)
...
(defrule determine-best-beer-attributes-if-he-is-going-to-smoke
   ...
   =>
   (assert (attribute (name best-flavor) (value crisp-clean)) CF 0.08)
   (assert (attribute (name best-color) (value pale)) CF 0.07)
   (assert (attribute (name best-alcohol) (value noticeable)) CF 0.05)
   (assert (attribute (name best-carbonation) (value medium)) CF 0.05)
...
(defrule preferred-color-is-pale
   ...
   =>
   (assert (attribute (name best-color) (value pale)) CF 0.2)
   (assert (attribute (name best-color) (value brown)) CF -0.1)
   (assert (attribute (name best-color) (value dark)) CF -0.2)
...
(defrule preferred-color-is-amber
   ...
   =>
   (assert (attribute (name best-color) (value amber)) CF 0.2)
   (assert (attribute (name best-color) (value dark)) CF -0.1)
...
(defrule preferred-color-is-brown
   ...
   =>
   (assert (attribute (name best-color) (value brown)) CF 0.2)
   (assert (attribute (name best-color) (value pale)) CF -0.1)
...
(defrule preferred-color-is-dark
   ...
   =>
   (assert (attribute (name best-color) (value dark)) CF 0.2)
   (assert (attribute (name best-color) (value amber)) CF -0.1)
   (assert (attribute (name best-color) (value pale)) CF -0.2)
...
(defrule preferred-alcohol-is-low
   ...
   =>
   (assert (attribute (name best-alcohol) (value not-detectable)) CF 0.2)
   (assert (attribute (name best-alcohol) (value noticeable)) CF -0.1)
   (assert (attribute (name best-alcohol) (value harsh)) CF -0.2)
...
(defrule preferred-alcohol-is-mild
   ...
   =>
   (assert (attribute (name best-alcohol) (value mild)) CF 0.2)
   (assert (attribute (name best-alcohol) (value harsh)) CF -0.1)
...
(defrule preferred-alcohol-is-high
   ...
   =>
   (assert (attribute (name best-alcohol) (value noticeable)) CF 0.2)
   (assert (attribute (name best-alcohol) (value not-detectable)) CF -0.1)
...
(defrule preferred-alcohol-is-very-high
   ...
   =>
   (assert (attribute (name best-alcohol) (value harsh)) CF 0.2)
   (assert (attribute (name best-alcohol) (value mild)) CF -0.1)
   (assert (attribute (name best-alcohol) (value not-detectable)) CF -0.2)
...
(defrule preferred-carbonation-is-low
   ...
   =>
   (assert (attribute (name best-carbonation) (value low)) CF 0.2)
   (assert (attribute (name best-carbonation) (value high)) CF -0.2)
...
(defrule preferred-carbonation-is-medium
   ...
   =>
   (assert (attribute (name best-carbonation) (value medium)) CF 0.2)
...
(defrule preferred-flavor-is-clean
   ...
   =>
   (assert (attribute (name best-flavor) (value crisp-clean)) CF 0.2)
...
(defrule preferred-flavor-is-sweet
   ...
   =>
   (assert (attribute (name best-flavor) (value malty-sweet)) CF 0.2)
   (assert (attribute (name best-flavor) (value hoppy-bitter)) CF -0.2)
...
(defrule preferred-flavor-is-roasty
   ...
   =>
   (assert (attribute (name best-flavor) (value dark-roasty)) CF 0.2)
   (assert (attribute (name best-flavor) (value fruity-spicy)) CF -0.2)
...
(defrule preferred-flavor-is-sour
   ...
   =>
   (assert (attribute (name best-flavor) (value sour-tart-funky)) CF 0.2)
...
(defrule determine-best-beer-attributes-if-which-pizza-topping-is-classic
   ...
   =>
   (assert (attribute (name best-flavor) (value crisp-clean)) CF 0.5)
...
(defrule determine-best-beer-attributes-if-which-pizza-topping-is-meat
   ...
   =>
   (assert (attribute (name best-flavor) (value hoppy-bitter)) CF 0.5)
   (assert (attribute (name best-flavor) (value malty-sweet)) CF -0.5)
...
(defrule determine-best-beer-attributes-if-which-pizza-topping-are-vegetables
  ...
  =>
  (assert (attribute (name best-flavor) (value sour-tart-funky)) CF 0.5)
...
(defrule determine-best-beer-attributes-if-which-pizza-topping-are-roasted-vegetables
   ...
   =>
   (assert (attribute (name best-flavor) (value dark-roasty)) CF 0.5)
   (assert (attribute (name best-flavor) (value fruity-spicy)) CF -0.5)
...
(defrule determine-best-beer-attributes-if-which-cheese-style-is-fresh
   ...
   =>
   (assert (attribute (name best-style) (value "Wheat Beer")) CF 0.8)
   (assert (attribute (name best-name) (value "Belgian-Style Fruit Lambic")) CF 0.8)
   (assert (attribute (name best-name) (value "Belgian-Style Lambic/Gueuze")) CF 0.8)
...
(defrule determine-best-beer-attributes-if-which-fresh-cheese-is-Mascarpone
   ...
   =>
   (assert (attribute (name best-name) (value "Belgian-Style Witbier")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-fresh-cheese-is-Ricotta-or-which-grain-is-bruschetta
   ...
   =>
   (assert (attribute (name best-name) (value "Honey Beer")) CF 0.9))

(defrule determine-best-beer-attributes-if-which-fresh-cheese-is-Chevre
   (declare (salience ?*medium-low-priority*))
   (which-fresh-cheese Chèvre)
   =>
   (assert (attribute (name best-name) (value "American Wheat")) CF 0.9)
   (assert (attribute (name best-name) (value "German-Style Hefeweizen")) CF 0.9)
   (assert (attribute (name best-name) (value "Belgian-Style Fruit Lambic")) CF 0.9)
   (assert (attribute (name best-name) (value "European-Style Export")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-fresh-cheese-is-Feta-or-which-pork-is-loin
   ...
   (or (which-fresh-cheese Feta)
       (which-pork loin))
   =>
   (assert (attribute (name best-name) (value "California Common")) CF 0.9))

(defrule determine-best-beer-attributes-if-which-fresh-cheese-is-Cream-Cheese
   (declare (salience ?*medium-low-priority*))
   (which-fresh-cheese "Cream Cheese")
   =>
   (assert (attribute (name best-name) (value "Fruit and Field Beer")) CF 0.9))

(defrule determine-best-beer-attributes-if-which-cheese-style-is-semi-soft
   (declare (salience ?*medium-low-priority*))
   (which-cheese-style semi-soft)
   =>
   (assert (attribute (name best-style) (value "Pale Ale")) CF 0.8)
   (assert (attribute (name best-name) (value "German-Style Bock")) CF 0.8)
   (assert (attribute (name best-name) (value "German-Style Kölsch")) CF 0.8)
...
(defrule determine-best-beer-attributes-if-which-semi-soft-cheese-is-Monterey-Jack-or-shellfish-is-mild
   ...
   =>
   (assert (attribute (name best-name) (value "American Cream Ale")) CF 0.9))

(defrule determine-best-beer-attributes-if-which-cheese-style-is-firm-hard
   (declare (salience ?*medium-low-priority*))
   (which-cheese-style firm/hard)
   =>
   (assert (attribute (name best-style) (value "Bock")) CF 0.8)
   (assert (attribute (name best-style) (value "Brown Ale")) CF 0.8)
   (assert (attribute (name best-name) (value "Bohemian-Style Pilsener")) CF 0.8)
   (assert (attribute (name best-name) (value "German-Style Pilsener")) CF 0.8)
   (assert (attribute (name best-name) (value "American Imperial Stout")) CF 0.8)
...
(defrule determine-best-beer-attributes-if-which-firm-hard-cheese-is-Swiss
   ...
   =>
   (assert (attribute (name best-name) (value "German-Style Maibock")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-firm-hard-cheese-is-Gouda
   ...
   (assert (attribute (name best-flavor) (value malty-sweet)) CF 0.5)
   (assert (attribute (name best-flavor) (value hoppy-bitter)) CF -0.5)
   (assert (attribute (name best-name) (value "German-Style Dunkelweizen")) CF 0.9))

(defrule determine-best-beer-attributes-if-which-type-of-Gouda-is-aged
   (declare (salience ?*medium-low-priority*))
   (which-type-of-Gouda aged)
   =>
   (assert (attribute (name best-name) (value "American Brown Ale")) CF 0.9)
   (assert (attribute (name best-name) (value "English-Style Brown Ale")) CF 0.9)
   (assert (attribute (name best-name) (value "Belgian-Style Quadrupel")) CF 0.9)
   (assert (attribute (name best-name) (value "Baltic-Style Porter")) CF 0.9)
   (assert (attribute (name best-name) (value "American Black Ale")) CF 0.9))

(defrule determine-best-beer-attributes-if-which-type-of-Gouda-is-smoked
   (declare (salience ?*medium-low-priority*))
   (which-type-of-Gouda smoked)
   =>
   (assert (attribute (name best-name) (value "American Imperial Porter")) CF 0.9))

(defrule determine-best-beer-attributes-if-which-firm-hard-cheese-is-Cheddar
   (declare (salience ?*medium-low-priority*))
   (which-firm/hard-cheese Cheddar)
   =>
   (assert (attribute (name best-name) (value "Irish-Style Red")) CF 0.9))

(defrule determine-best-beer-attributes-if-which-color-of-Cheddar-is-white
   (declare (salience ?*medium-low-priority*))
   (which-color-of-Cheddar white)
   =>
   (assert (attribute (name best-name) (value "American Amber Lager")) CF 0.9)
   (assert (attribute (name best-name) (value "German-Style Pilsener")) CF 0.9))

(defrule determine-best-beer-attributes-if-which-Cheddar-seasoning-is-mild
   (declare (salience ?*medium-low-priority*))
   (which-Cheddar-seasoning mild)
   =>
   (assert (attribute (name best-name) (value "American Pale Ale")) CF 0.9)
   (assert (attribute (name best-name) (value "English-Style Mild")) CF 0.9))

(defrule determine-best-beer-attributes-if-which-Cheddar-seasoning-is-medium
   (declare (salience ?*medium-low-priority*))
   (which-Cheddar-seasoning medium)
   =>
   (assert (attribute (name best-name) (value "American Amber Ale")) CF 0.9)
   (assert (attribute (name best-name) (value "American Pale Ale")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-Cheddar-seasoning-is-aged
   ...
   (assert (attribute (name best-flavor) (value hoppy-bitter)) CF 0.5)
   (assert (attribute (name best-flavor) (value malty-sweet)) CF -0.5)
   (assert (attribute (name best-name) (value "English-Style IPA")) CF 0.9)
   (assert (attribute (name best-name) (value "English-Style Oatmeal Stout")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-Cheddar-is-sharp-or-which-rich-is-grilled-lamb
   ...
   (or (Cheddar-is-sharp yes)
       (and (meat-cooking-method grilled)
            (which-rich lamb)))
   =>
   (assert (attribute (name best-name) (value "American Stout")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-color-of-Cheddar-is-white-and-which-Cheddar-seasoning-is-mild
   ...
   (which-Cheddar-seasoning mild)
   =>
   (assert (attribute (name best-name) (value "Bohemian-Style Pilsener")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-type-of-Swiss-is-Emmental-or-which-bluefish-is-grilled-salmon
   ...
   =>
   (assert (attribute (name best-name) (value "German-Style Brown/Altbier")) CF 0.9))

(defrule determine-best-beer-attributes-if-which-type-of-Swiss-is-Gruyere
   (declare (salience ?*medium-low-priority*))
   (which-type-of-Swiss Gruyère)
   =>
   (assert (attribute (name best-name) (value "English-Style Brown Porter")) CF 0.9)
   (assert (attribute (name best-name) (value "Robust Porter")) CF 0.9))

(defrule determine-best-beer-attributes-if-Swiss-is-aged
   (declare (salience ?*medium-low-priority*))
   (Swiss-is-aged yes)
   =>
   (assert (attribute (name best-name) (value "German-Style Bock")) CF 0.9))

(defrule determine-best-beer-attributes-if-which-firm-hard-cheese-is-Parmesan
   (declare (salience ?*medium-low-priority*))
   (which-firm/hard-cheese Parmesan)
   =>
   (assert (attribute (name best-name) (value "Smoke Beer")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-cheese-style-is-blue
   ...
   (assert (attribute (name best-flavor) (value dark-roasty)) CF 0.5)
   (assert (attribute (name best-flavor) (value fruity-spicy)) CF -0.5)
   (assert (attribute (name best-style) (value "India Pale Ale")) CF 0.8)
   (assert (attribute (name best-name) (value "American Black Ale")) CF 0.8)
...
(defrule determine-best-beer-attributes-if-which-blue-or-natural-rind-cheese-is-Stilton
   ...
   =>
   (assert (attribute (name best-name) (value "British-Style Barley Wine Ale")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-cheese-style-is-natural-rind
   ...
   =>
   (assert (attribute (name best-style) (value "Pale Ale")) CF 0.8)
   (assert (attribute (name best-name) (value "Belgian-Style Golden Strong Ale")) CF 0.8)
   (assert (attribute (name best-name) (value "Belgian-Style Blonde Ale")) CF 0.8)
   (assert (attribute (name best-name) (value "Blonde Ale")) CF 0.8)
   (assert (attribute (name best-name) (value "American Barley Wine")) CF 0.8)
   (assert (attribute (name best-name) (value "British-Style Barley Wine Ale")) CF 0.8)
...
(defrule determine-best-beer-attributes-if-which-natural-rind-cheese-is-Brie
   ...
   (assert (attribute (name best-flavor) (value fruity-spicy)) CF 0.5)
   (assert (attribute (name best-flavor) (value dark-roasty)) CF -0.5)
   (assert (attribute (name best-name) (value "Belgian-Style Blonde Ale")) CF 0.9)
   (assert (attribute (name best-name) (value "Belgian-Style Saison")) CF 0.9))

(defrule determine-best-beer-attributes-if-which-natural-rind-cheese-is-Camembert
   (declare (salience ?*medium-low-priority*))
   (which-natural-rind-cheese Camembert)
   =>
   (assert (attribute (name best-name) (value "Pumpkin Beer")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-natural-rind-cheese-is-Triple-Creme
   ...
   =>
   (assert (attribute (name best-name) (value "Belgian-Style Golden Strong Ale")) CF 0.9)
   (assert (attribute (name best-name) (value "Belgian-Style Tripel")) CF 0.9))

(defrule determine-best-beer-attributes-if-which-natural-rind-cheese-is-Mimolette
   (declare (salience ?*medium-low-priority*))
   (which-natural-rind-cheese Mimolette)
   =>
   (assert (attribute (name best-name) (value "Belgian-Style Flanders")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-cheese-style-is-washed-rind
   ...
   (assert (attribute (name best-name) (value "Belgian-Style Blonde Ale")) CF 0.8)
   (assert (attribute (name best-name) (value "Belgian-Style Golden Strong Ale")) CF 0.8)
   (assert (attribute (name best-name) (value "Belgian-Style Pale Ale")) CF 0.8)
   (assert (attribute (name best-name) (value "Belgian-Style Dubbel")) CF 0.8)
   (assert (attribute (name best-name) (value "French-Style Biére de Garde")) CF 0.8)
...
(defrule determine-best-beer-attributes-if-which-washed-rind-cheese-is-Taleggio
   ...
   =>
   (assert (attribute (name best-name) (value "Belgian-Style Pale Ale")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-grain-are-chips
   ...
   (which-grain chips)
   =>
   (assert (attribute (name best-name) (value "English-Style Bitter")) CF 0.9)
   (assert (attribute (name best-name) (value "English-Style Pale Ale (ESB)")) CF 0.9)
   (assert (attribute (name best-name) (value "Belgian-Style Pale Ale")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-grain-is-spaghetti
   ...
   =>
   (assert (attribute (name best-name) (value "Blonde Ale")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-which-entree-is-fish
   ...
   (which-entrée fish)
   =>
   (assert (attribute (name best-name) (value "English-Style Bitter")) CF 0.8)
   (assert (attribute (name best-name) (value "English-Style Pale Ale (ESB)")) CF 0.8)
...
(defrule determine-best-beer-attributes-if-which-shellfish-are-mussels
   ...
   =>
   (assert (attribute (name best-name) (value "Belgian-Style Saison")) CF 0.9)
   (assert (attribute (name best-name) (value "Belgian-Style Lambic/Gueuze")) CF 0.9))

(defrule determine-best-beer-attributes-if-which-shellfish-are-oysters
   (declare (salience ?*medium-low-priority*))
   (which-shellfish oysters)
   =>
   (assert (attribute (name best-name) (value "Irish-Style Dry Stout")) CF 0.9))

(defrule determine-best-beer-attributes-if-which-which-entree-is-meat
   (declare (salience ?*medium-low-priority*))
   (which-entrée meat)
   =>
   (assert (attribute (name best-name) (value "Scotch Ale/Wee Heavy")) CF 0.8)
   (assert (attribute (name best-name) (value "Scottish-Style Ale")) CF 0.8)
...
(defrule determine-best-beer-attributes-if-meat-cooking-method-is-grilled
   ...
   (assert (attribute (name best-name) (value "American Pale Ale")) CF 0.9)
   (assert (attribute (name best-name) (value "American Amber Lager")) CF 0.9)
   (assert (attribute (name best-name) (value "Vienna-Style Lager")) CF 0.9)
   (assert (attribute (name best-name) (value "American Brown Ale")) CF 0.9)
   (assert (attribute (name best-name) (value "English-Style Brown Porter")) CF 0.9)
   (assert (attribute (name best-name) (value "Robust Porter")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-rich-is-roasted-beef-or-which-rich-is-lamb
   ...
   (or (and (meat-cooking-method roasted)
       ...
       (which-rich lamb))
   =>
   (assert (attribute (name best-name) (value "English-Style Old Ale")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-beef-is-bresola
   ...
   =>
   (assert (attribute (name best-name) (value "American Brown Ale")) CF 0.9)
   (assert (attribute (name best-name) (value "Rye Beer")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-rich-is-roasted-lamb
   ...
   (which-rich lamb)
   =>
   (assert (attribute (name best-name) (value "French-Style Biére de Garde")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-rich-is-pork
   ...
   (assert (attribute (name best-flavor) (value malty-sweet)) CF -0.5)
   (assert (attribute (name best-flavor) (value dark-roasty)) CF -0.5)
   (assert (attribute (name best-name) (value "German-Style Doppelbock")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-pork-is-tenderloin
   ...
   =>
   (assert (attribute (name best-name) (value "Coffee Beer")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-pork-is-mortadella
   ...
   =>
   (assert (attribute (name best-name) (value "German-Style Märzen/Oktoberfest")) CF 0.9)
   (assert (attribute (name best-name) (value "Belgian-Style Tripel")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-pork-is-sausage
   ...
   (which-pork sausage)
   =>
   (assert (attribute (name best-name) (value "German-Style Dunkel")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-pork-is-grilled-sausage
   ...
   (which-pork sausage)
   =>
   (assert (attribute (name best-name) (value "Smoke Porter")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-sausage-is-soppressata
   ...
   =>
   (assert (attribute (name best-name) (value "American Brown Ale")) CF 0.9)
   (assert (attribute (name best-name) (value "Belgian-Style Dubbel")) CF 0.9))

(defrule determine-best-beer-attributes-if-which-sausage-is-salame-piccante
   (declare (salience ?*medium-low-priority*))
   (which-sausage "salame piccante")
   =>
   (assert (attribute (name best-name) (value "Imperial IPA")) CF 0.9)
   (assert (attribute (name best-name) (value "Rye Beer")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-poultry-is-chicken
   ...
   =>
   (assert (attribute (name best-name) (value "German-Style Weizenbock")) CF 0.9)
   (assert (attribute (name best-name) (value "Bohemian-Style Pilsener")) CF 0.9)
   (assert (attribute (name best-name) (value "German-Style Pilsener")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-meat-is-game
   ...
   (which-meat game)
   =>
   (assert (attribute (name best-name) (value "Scotch Ale/Wee Heavy")) CF 0.9)
   (assert (attribute (name best-name) (value "Scottish-Style Ale")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-meat-is-grilled-or-roasted-game
   ...
   (which-meat game)
   =>
   (assert (attribute (name best-name) (value "American Brett")) CF 0.9))
...
(defrule determine-best-beer-attributes-if-which-entree-is-vegetables
   ...
   =>
   (assert (attribute (name best-name) (value "American Amber Lager")) CF 0.8)
   (assert (attribute (name best-name) (value "Vienna-Style Lager")) CF 0.8)
   (assert (attribute (name best-name) (value "American Brown Ale")) CF 0.8)
...
(defrule determine-best-beer-attributes-if-which-fats-is-vegetable
   ...
   =>
   (assert (attribute (name best-carbonation) (value high)) CF 0.5)
   (assert (attribute (name best-carbonation) (value medium)) CF 0.2)
   (assert (attribute (name best-carbonation) (value low)) CF -0.5))
...
(defrule determine-best-beer-attributes-if-creamy-dessert-is-fruit
   ...
   (assert (attribute (name best-name) (value "Scotch Ale/Wee Heavy")) CF 0.9)
   (assert (attribute (name best-name) (value "Scottish-Style Ale")) CF 0.9)
   (assert (attribute (name best-name) (value "American Sour")) CF 0.9)
...
(defrule determine-best-beer-attributes-if-which-chocolate-is-semisweet
   ...
   (assert (attribute (name best-name) (value "Robust Porter")) CF 0.9)
   (assert (attribute (name best-name) (value "Belgian-Style Dubbel")) CF 0.9)
   (assert (attribute (name best-name) (value "American IPA")) CF 0.9))

(defrule determine-best-beer-attributes-if-which-chocolate-is-bittersweet
   (declare (salience ?*medium-low-priority*))
   (which-chocolate bittersweet)
   =>
   (assert (attribute (name best-name) (value "American Imperial Stout")) CF 0.9)
   (assert (attribute (name best-name) (value "Belgian-Style Dubbel")) CF 0.9)
   (assert (attribute (name best-name) (value "Belgian-Style Quadrupel")) CF 0.9)
   (assert (attribute (name best-name) (value "Belgian-Style Fruit Lambic")) CF 0.9)
   (assert (attribute (name best-name) (value "Belgian-Style Lambic/Gueuze")) CF 0.9)
